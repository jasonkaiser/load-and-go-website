...
export const Card = ({ card }) => {
  ...
  return (
<div className="group relative z-10 flex h-80 w-56 flex-col items-start justify-start overflow-hidden rounded-4xl bg-gray-100 md:h-[40rem] md:w-96 dark:bg-neutral-900">
